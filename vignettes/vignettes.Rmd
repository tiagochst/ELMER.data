...
=======
>>>>>>> 704e083d2bab8a8676b819a55880e8c496caf9e6
```
```{r, message=FALSE}
...
A curated list of TF was retrieved from Lambert, Samuel A., et al. "The human transcription factors." Cell 172.4 (2018): 650-665 with the following code.
```{r, eval=FALSE, include=TRUE}
